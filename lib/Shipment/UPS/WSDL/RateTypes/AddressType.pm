package Shipment::UPS::WSDL::RateTypes::AddressType;
use strict;
use warnings;
...
AddressType from the namespace http://www.ups.com/XMLSchema/XOLTWS/Rate/v1.1.
...
=item * AddressLine (min/maxOccurs: 0/3)
