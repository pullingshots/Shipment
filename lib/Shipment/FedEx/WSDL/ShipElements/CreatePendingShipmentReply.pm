...
package Shipment::FedEx::WSDL::ShipElements::CreatePendingShipmentReply;
use strict;
use warnings;
...
__PACKAGE__->__set_name('CreatePendingShipmentReply');
...
CreatePendingShipmentReply from the namespace http://fedex.com/ws/ship/v9.
...
=head2 new
 ...
 my $element = Shipment::FedEx::WSDL::ShipElements::CreatePendingShipmentReply->new($data);
