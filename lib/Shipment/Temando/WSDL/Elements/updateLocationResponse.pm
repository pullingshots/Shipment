...
__PACKAGE__->__set_name('updateLocationResponse');
...
updateLocationResponse from the namespace http://' . $Shipment::Temando::WSDL::Interfaces::quoting_Service::quoting_port::ns_url . '/schema/2009_06/server.xsd.
...
=head2 new
 ...
 my $element = Shipment::Temando::WSDL::Elements::updateLocationResponse->new($data);
