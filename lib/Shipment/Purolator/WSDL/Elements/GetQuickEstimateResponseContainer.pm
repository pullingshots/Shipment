...
package Shipment::Purolator::WSDL::Elements::GetQuickEstimateResponseContainer;
use strict;
use warnings;
...
Shipment::Purolator::WSDL::Elements::GetQuickEstimateResponseContainer
...
=head2 new
 ...
 my $element = Shipment::Purolator::WSDL::Elements::GetQuickEstimateResponseContainer->new($data);
