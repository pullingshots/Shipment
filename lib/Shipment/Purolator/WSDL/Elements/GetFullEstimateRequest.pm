...
GetFullEstimateRequest from the namespace http://purolator.com/pws/datatypes/v1.
...
=head2 new
 ...
 my $element = Shipment::Purolator::WSDL::Elements::GetFullEstimateRequest->new($data);
