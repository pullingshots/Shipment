...
package Shipment::Purolator::WSDL::Elements::ArrayOfShortAddress;
use strict;
use warnings;
...
Shipment::Purolator::WSDL::Elements::ArrayOfShortAddress
...
=head2 new
 ...
 my $element = Shipment::Purolator::WSDL::Elements::ArrayOfShortAddress->new($data);
