...
package Shipment::Purolator::WSDLV2::Elements::Address;
use strict;
use warnings;
...
Shipment::Purolator::WSDLV2::Elements::Address
...
=head2 new
 ...
 my $element = Shipment::Purolator::WSDLV2::Elements::Address->new($data);
