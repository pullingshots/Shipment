...
package Shipment::Purolator::WSDLV2::Elements::OptionRule;
use strict;
use warnings;
...
Shipment::Purolator::WSDLV2::Elements::OptionRule
...
=head2 new
 ...
 my $element = Shipment::Purolator::WSDLV2::Elements::OptionRule->new($data);
