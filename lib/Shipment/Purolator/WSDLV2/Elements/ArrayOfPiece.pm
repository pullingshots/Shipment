...
package Shipment::Purolator::WSDLV2::Elements::ArrayOfPiece;
use strict;
use warnings;
...
Shipment::Purolator::WSDLV2::Elements::ArrayOfPiece
...
=head2 new
 ...
 my $element = Shipment::Purolator::WSDLV2::Elements::ArrayOfPiece->new($data);
