...
package Shipment::Purolator::WSDLV2::Elements::ReturnShipment;
use strict;
use warnings;
...
Shipment::Purolator::WSDLV2::Elements::ReturnShipment
...
=head2 new
 ...
 my $element = Shipment::Purolator::WSDLV2::Elements::ReturnShipment->new($data);
