...
package Shipment::Purolator::WSDLV2::Elements::CreateShipmentRequestContainer;
use strict;
use warnings;
...
Shipment::Purolator::WSDLV2::Elements::CreateShipmentRequestContainer
...
=head2 new
 ...
 my $element = Shipment::Purolator::WSDLV2::Elements::CreateShipmentRequestContainer->new($data);
