...
package Shipment::Purolator::WSDL::Elements::SenderInformation;
use strict;
use warnings;
...
Shipment::Purolator::WSDL::Elements::SenderInformation

=head1 DESCRIPTION

Perl data type class for the XML Schema defined element
SenderInformation from the namespace http://purolator.com/pws/datatypes/v1.
...
=head2 new
 ...
 my $element = Shipment::Purolator::WSDL::Elements::SenderInformation->new($data);
