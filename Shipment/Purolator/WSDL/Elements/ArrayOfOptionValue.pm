...
package Shipment::Purolator::WSDL::Elements::ArrayOfOptionValue;
use strict;
use warnings;
...
Shipment::Purolator::WSDL::Elements::ArrayOfOptionValue
...
=head2 new
 ...
 my $element = Shipment::Purolator::WSDL::Elements::ArrayOfOptionValue->new($data);
